...
var css = {
  code: "h1.svelte-11eww9j{color:purple}b.svelte-11eww9j{color:red}",
  map: "{\"version\":3,\"file\":\"app.svelte\",\"sources\":[\"app.svelte\"],\"sourcesContent\":[\"<script>\\n\\texport let name;\\n\\n    let count = 0;\\n\\n    function handleClick () {\\n        count = count + 1;\\n    }\\n</script>\\n\\n<style>\\n\\th1 {\\n\\t\\tcolor: purple;\\n\\t}\\n\\n    b {\\n        color: red;\\n    }\\n</style>\\n\\n<svelte:head>\\n    <title>123</title>\\n</svelte:head>\\n\\n<div id=\\\"app\\\">\\n    <h1>hello, {name}</h1>\\n\\n    <button on:click={handleClick}>\\n        count: {count}\\n    </button>\\n\\n    {#if count > 1}\\n        <b>count > 1</b>\\n    {/if}\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAWC,EAAE,eAAC,CAAC,AACH,KAAK,CAAE,MAAM,AACd,CAAC,AAEE,CAAC,eAAC,CAAC,AACC,KAAK,CAAE,GAAG,AACd,CAAC\"}"
};
var App = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_1__["create_ssr_component"])(function ($$result, $$props, $$bindings, $$slots) {
  var name = $$props.name;
  var count = 0;
  ...
  $$result.css.add(css);
  return "".concat(($$result.head += "<title>123</title>", ""), "\n\n<div id=\"", "app", "\">\n    <h1 class=\"", "svelte-11eww9j", "\">hello, ").concat(Object(svelte_internal__WEBPACK_IMPORTED_MODULE_1__["escape"])(name), "</h1>\n\n    <button>\n        count: ").concat(Object(svelte_internal__WEBPACK_IMPORTED_MODULE_1__["escape"])(count), "\n    </button>\n\n    ").concat(count > 1 ? "<b class=\"".concat("svelte-11eww9j", "\">count &gt; 1</b>") : "", "\n</div>");
});
...
/******/ });
//# sourceMappingURL=spring-2020-program.js.map